...
public class AnalyteStat implements JsonSerializable, Comparable<AnalyteStat> {
	...
	@Override
	public int compareTo(AnalyteStat o) {
		if (this.getIncludedDates().get(0).getTime() - o.getIncludedDates().get(0).getTime() == 0)
			return 0;
		if (this.getIncludedDates().get(0).getTime() - o.getIncludedDates().get(0).getTime() > 0)
			return 1;
		else
